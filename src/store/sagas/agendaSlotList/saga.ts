...
export const fetchAgendaSlotListSaga = tryCatch(function* fetchAgendaSlotListSagaSafe() {
  const response: AxiosResponse<AgendaSlotListType> = yield call(sendFetchAgendaSlotListRequest);
